...
def robot_1():
    ...
    robot_1.BehaviorManager.runBehavior("sbr_71130_pepper-ondo")

def robot_2():

    Robot_IP = "192.168.1.3"
    robot_2.BehaviorManager = ALProxy("ALBehaviorManager",Robot_IP,9559)
    robot_2.BehaviorManager.runBehavior("sbr_71130_pepper-ondo")
...
def robot_3():
    ...
    robot_3.BehaviorManager.runBehavior("sbr_71130_pepper-ondo")

def robot_4():

    Robot_IP = "192.168.1.5"
    robot_4.BehaviorManager = ALProxy("ALBehaviorManager",Robot_IP,9559)
    robot_4.BehaviorManager.runBehavior("sbr_71130_pepper-ondo")

def robot_5():

    Robot_IP = "192.168.1.7"
    robot_5.BehaviorManager = ALProxy("ALBehaviorManager",Robot_IP,9559)
    robot_5.BehaviorManager.runBehavior("sbr_71130_pepper-ondo")
